...
if __name__ == "__main__": x = torch.randn(4, 64, 32, 32) # 一个示例输入，形状为 (batch_size, channels, height, width) bilevel_attention = BiLevelRoutingAttention(64) out = bilevel_attention(x) print(out.shape) # 应该输出 torch.Size([4, 64, 32, 32])
